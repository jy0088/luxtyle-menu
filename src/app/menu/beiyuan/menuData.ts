...
export const mealSet: MenuCategory = {
  ...
  items: [
    ...
    { id: 'M-A-05', nameEn: 'Beef Bowl', nameCn: '牛丼套餐', price: 18.95 },
    { id: 'M-A-06', nameEn: 'Teriyaki Eel Meal Set', nameCn: '鳗鱼套餐', price: 24.95 },
    { id: 'M-A-07', nameEn: 'Spiced Chicken Meal Set', nameCn: '台式红烧鸡套餐', price: 18.95 },
    { id: 'M-A-08', nameEn: 'Beef Stew Rice Meal Set', nameCn: '台式牛肉饭套餐', price: 18.95 },
    { id: 'M-A-09', nameEn: 'Spicy Tonkotsu Ramen', nameCn: '辣味豚骨拉面', price: 19.95, note: '辣度可选' },
...
export const entreeDishes: MenuCategory = {
  ...
  items: [
    ...
    { id: 'M-B-12', nameEn: 'Beef Short Ribs', nameCn: '香煎牛小排', price: 15.98, note: '咸甜' },
...
export const noodles: MenuCategory = {
  ...
  type: 'items',
  items: [
    { id: 'M-C-01', nameEn: 'Instant Noodle with Egg', nameCn: '台式泡面加蛋', price: 8.98 },
    { id: 'M-C-02', nameEn: 'Instant Beef Noodle with Ham and Egg', nameCn: '广式公仔泡面', price: 8.98 },
    { id: 'M-C-03', nameEn: 'Stir Fried Instant Noodle with Sausage', nameCn: '金门炒泡面', price: 17.98 },
    ...
    { id: 'M-C-07', nameEn: 'Ja-Jang Noodle', nameCn: '廟口炸酱面', price: 16.98, note: '微甜' },
    { id: 'M-C-08', nameEn: "Pu-Erh Flavored Beef Stew Noodle", nameCn: '台式普洱牛肉面', price: 16.98 },
    { id: 'M-C-09', nameEn: 'Beef Soup with Dumplings', nameCn: '牛肉汤水饺', price: 18.98 },
    { id: 'M-C-10', nameEn: 'Wonton Noodle Soup', nameCn: '馄饨面', price: 16.98 },
...
export const snacks: MenuCategory = {
  ...
  type: 'items',
  items: [
    { id: 'S01', nameEn: 'Tea Boiled Eggs (2 pcs)', nameCn: '茶叶蛋', price: 3.98 },
    ...
    { id: 'S08', nameEn: 'Fried Squid Balls', nameCn: '炸花枝丸', price: 7.98 },
    { id: 'S09', nameEn: 'Takoyaki (Octopus Balls)', nameCn: '章鱼烧', price: 9.49 },
    { id: 'S10', nameEn: 'Spicy Wontons', nameCn: '红油抄手', price: 8.49 },
    { id: 'S11', nameEn: 'Taiwan Bok Choy / Cabbage', nameCn: '烫青菜', price: 7.98 },
    { id: 'S12', nameEn: 'Green Onion Pancake', nameCn: '葱油饼', price: 7.98, note: '可选加蛋' },
...
export const dessert: MenuCategory = {
  ...
  items: [
    ...
    { id: 'S-B-04', nameEn: 'Plum Sweet Potato Fries', nameCn: '梅香地瓜条', price: 8.98 },
