...
export const icedFlavoredTea: MenuCategory = {
  ...
  items: [
    ...
    { id: 'C-A-02', nameEn: 'Mango Ice Tea', nameCn: '芒果冰茶', price: 5.98, teaBases: ['B','G','O'], img: '/beiyuan-C-A-02.webp' },
    { id: 'C-A-03', nameEn: 'Passion Fruit Tea', nameCn: '百香冰茶', price: 5.98, teaBases: ['B','G','O'], img: '/beiyuan-C-A-03.webp' },
    { id: 'C-A-04', nameEn: 'Peach Tea', nameCn: '水蜜桃茶', price: 5.98, teaBases: ['B','G','O'], img: '/beiyuan-C-A-04.webp' },
    { id: 'C-A-05', nameEn: 'Honey Tea', nameCn: '蜂蜜茶', price: 5.98, teaBases: ['B','G','O'], img: '/beiyuan-C-A-05.webp' },
    { id: 'C-A-06', nameEn: 'Lychee Tea', nameCn: '荔枝茶', price: 5.98, teaBases: ['B','G','O'], img: '/beiyuan-C-A-06.webp' },
    { id: 'C-A-07', nameEn: 'Rose Black Tea', nameCn: '玫瑰红茶', price: 5.98, img: '/beiyuan-C-A-07.webp' },
...
export const icedMilkTea: MenuCategory = {
  ...
  customization: { sweetness: true, ice: true, topping: true, size: 'fixed', teaBase: true },
  items: [
    { id: 'C-B-01', nameEn: 'Milk Tea', nameCn: '奶茶', price: 5.98, teaBases: ['B','G','O'], img: '/beiyuan-C-B-01.webp' },
    { id: 'C-B-02', nameEn: 'Honey Milk Tea', nameCn: '蜂蜜奶茶', price: 6.49, teaBases: ['B','G','O'], img: '/beiyuan-C-B-02.webp' },
    { id: 'C-B-03', nameEn: 'Brown Sugar Tapioca Milk Tea', nameCn: '黑糖奶茶', price: 6.49, teaBases: ['B','G','O'], img: '/beiyuan-C-B-03.webp' },
    { id: 'C-B-04', nameEn: 'Wintermelon Milk Tea', nameCn: '冬瓜奶茶', price: 6.49, teaBases: ['B','G','O'], img: '/beiyuan-C-B-04.webp' },
...
export const hotMilkTea: MenuCategory = {
  ...
  items: [
    ...
    { id: 'H-B-03', nameEn: 'Wintermelon Milk Tea', nameCn: '冬瓜奶茶', price: 6.49, img: '/beiyuan-H-B-03.webp' },
    { id: 'H-B-04', nameEn: 'Royal Milk Tea', nameCn: '皇家奶茶', price: 6.49, img: '/beiyuan-H-B-04.webp' },
    { id: 'H-B-05', nameEn: 'Thai Tea', nameCn: '泰式奶茶', price: 6.49, img: '/beiyuan-H-B-05.webp' },
    { id: 'H-B-06', nameEn: 'Rose Milk Tea', nameCn: '玫瑰奶茶', price: 6.49, img: '/beiyuan-H-B-06.webp' },
    { id: 'H-B-07', nameEn: 'Hot Matcha', nameCn: '热抹茶', price: 6.49, img: '/beiyuan-H-B-07.webp' },
    { id: 'H-B-08', nameEn: 'Lavender Milk Tea', nameCn: '薰衣草奶茶', price: 6.49, img: '/beiyuan-H-B-08.webp' },
    { id: 'H-B-10', nameEn: 'Roasted Oolong Milk Tea', nameCn: '岩炭乌龙奶茶', price: 6.98, img: '/beiyuan-H-B-10.webp' },
    { id: 'H-B-11', nameEn: 'Longan Jujube Milk Tea', nameCn: '桂圆红枣奶茶', price: 6.98, img: '/beiyuan-H-B-11.webp' },
    { id: 'H-B-12', nameEn: 'Ginger Jujube Milk Tea', nameCn: '生姜红枣奶茶', price: 6.98, img: '/beiyuan-H-B-12.webp' },
    { id: 'H-B-13', nameEn: 'Star Anise Milk Tea', nameCn: '八角奶茶', price: 6.98, img: '/beiyuan-H-B-13.webp' },
  ],
};
...
export const entreeDishes: MenuCategory = {
  ...
  type: 'items',
  items: [
    { id: 'M-B-01', nameEn: 'Spiced Pork Knuckles', nameCn: '台式烧猪脚', price: 14.98, img: '/beiyuan-M-B-01.webp' },
    { id: 'M-B-02', nameEn: 'Spiced Pork Chop', nameCn: '香酥炸排骨', price: 12.98, img: '/beiyuan-M-B-02.webp' },
    { id: 'M-B-03', nameEn: 'Curry Chicken Cutlet', nameCn: '咖喱鸡排', price: 12.98, img: '/beiyuan-M-B-03.webp' },
    { id: 'M-B-04', nameEn: 'Marinated Chicken', nameCn: '香酥鸡排', price: 12.98, img: '/beiyuan-M-B-04.webp' },
    { id: 'M-B-05', nameEn: 'Fish Fillet', nameCn: '台式炸鱼排', price: 12.98, img: '/beiyuan-M-B-05.webp' },
    { id: 'M-B-06', nameEn: 'Beef Short Ribs', nameCn: '香煎牛小排', price: 16.98, img: '/beiyuan-M-B-06.webp' },
  ],
};
...
export const noodles: MenuCategory = {
  ...
  type: 'items',
  items: [
    { id: 'M-C-01', nameEn: 'Instant Noodle with Egg', nameCn: '台式泡面加蛋', price: 8.98, img: '/beiyuan-M-C-01.webp' },
    { id: 'M-C-02', nameEn: 'Instant Beef Noodle with Ham and Egg', nameCn: '广式公仔泡面', price: 8.98, img: '/beiyuan-M-C-02.webp' },
    { id: 'M-C-03', nameEn: 'Stir Fried Instant Noodle with Sausage', nameCn: '金门炒泡面', price: 18.98, img: '/beiyuan-M-C-03.webp' },
    { id: 'M-C-04', nameEn: 'Sausage Fried Rice', nameCn: '台式香肠炒饭', price: 18.98, img: '/beiyuan-M-C-04.webp' },
    { id: 'M-C-05', nameEn: 'House Noodle with Deli Plate', nameCn: '阳春肉燥汤面加拼盘', price: 17.98, img: '/beiyuan-M-C-05.webp' },
    { id: 'M-C-06', nameEn: 'Rice Noodle with Deli Plate', nameCn: '阳春肉燥汤面米粉加拼盘', price: 17.98, img: '/beiyuan-M-C-06.webp' },
    { id: 'M-C-07', nameEn: 'Ja-Jang Noodle', nameCn: '廟口炸酱面', price: 17.98, note: '微甜', img: '/beiyuan-M-C-07.webp' },
    { id: 'M-C-08', nameEn: 'Pu-Erh Flavored Beef Stew Noodle', nameCn: '台式普洱牛肉面', price: 17.98, img: '/beiyuan-M-C-08.webp' },
...
export const dessert: MenuCategory = {
  ...
  type: 'items',
  items: [
    { id: 'S-B-01', nameEn: 'Plain Butter Toast', nameCn: '奶油厚片', price: 4.98, img: '/beiyuan-S-B-01.webp' },
    { id: 'S-B-02', nameEn: 'Peanut Butter / Strawberry / Condensed Milk Toast', nameCn: '花生/草莓/炼奶吐司', price: 5.98, img: '/beiyuan-S-B-02.webp' },
    { id: 'S-B-03', nameEn: 'Sweet Butter Toast', nameCn: '奶油奶酥厚片', price: 5.98, img: '/beiyuan-S-B-03.webp' },
    { id: 'S-B-04', nameEn: 'Plum Sweet Potato Fries', nameCn: '梅香地瓜条', price: 8.98, img: '/beiyuan-S-B-04.webp' },
    { id: 'S-B-05', nameEn: 'Fried Taro Balls', nameCn: '台式炸芋头丸', price: 8.98, img: '/beiyuan-S-B-05.webp' },
    { id: 'S-B-06', nameEn: 'Hot Grass Jelly', nameCn: '烧仙草', price: 7.98, img: '/beiyuan-S-B-06.webp' },
    { id: 'S-B-07', nameEn: 'Red Bean Soup w/ Rice Balls', nameCn: '红豆汤圆', price: 7.98, img: '/beiyuan-S-B-07.webp' },
    { id: 'S-B-08', nameEn: 'Red Bean Soup w/ Taro Balls', nameCn: '红豆芋圆', price: 7.98, note: '桂花乌龙汤底', img: '/beiyuan-S-B-08.webp' },
    { id: 'S-B-09', nameEn: 'Taro Balls in Taro Milk', nameCn: '芋圆红豆烧', price: 7.98, note: '芋头沙奶汤底', img: '/beiyuan-S-B-09.webp' },
    { id: 'S-B-10', nameEn: 'Brown Sugar Sticky Rice Cake (12 pcs)', nameCn: '红糖糍粑', price: 8.98, note: '花生粉或黄豆粉，含过敏源', img: '/beiyuan-S-B-10.webp' },
    { id: 'S-B-11', nameEn: 'Honey Osmanthus Cake (6 pcs)', nameCn: '蜂蜜桂花糕', price: 7.98, img: '/beiyuan-S-B-11.webp' },
  ],
};
